...
function greeter(hour) {// greeter function will accept parameter hour
    // YOUR CODE BELOW HERE //
    if (hour <= 11) { //check for hour value
        console.log("Good Morning!");//console log corresponding value
    } else if (hour <= 16) { //repeat
